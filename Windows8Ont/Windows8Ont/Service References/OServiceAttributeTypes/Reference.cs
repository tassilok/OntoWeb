...
// 
namespace Windows8Ont.OServiceAttributeTypes {
    ...
    public interface OServiceAttributeTypesSoap {
        ...
        System.Threading.Tasks.Task<Windows8Ont.OServiceAttributeTypes.Config[]> ConfigAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AttributeTypes", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<Windows8Ont.OServiceAttributeTypes.clsOntologyItem[]> AttributeTypesAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AttributeTypesByAttributeTypeGuid", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<Windows8Ont.OServiceAttributeTypes.clsOntologyItem[]> AttributeTypesByAttributeTypeGuidAsync(string guidAttributeType);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AttributeTypesByAttributeTypeName", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<Windows8Ont.OServiceAttributeTypes.clsOntologyItem[]> AttributeTypesByAttributeTypeNameAsync(string nameAttributeType, bool strict, bool caseSensitive);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<Windows8Ont.OServiceAttributeTypes.clsOntologyItem[]> AttributeTypesByAttributeTypeIdDataTypeAsync(string idDataType);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface OServiceAttributeTypesSoapChannel : Windows8Ont.OServiceAttributeTypes.OServiceAttributeTypesSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class OServiceAttributeTypesSoapClient : System.ServiceModel.ClientBase<Windows8Ont.OServiceAttributeTypes.OServiceAttributeTypesSoap>, Windows8Ont.OServiceAttributeTypes.OServiceAttributeTypesSoap {
        ...
        public OServiceAttributeTypesSoapClient() : 
                base(OServiceAttributeTypesSoapClient.GetDefaultBinding(), OServiceAttributeTypesSoapClient.GetDefaultEndpointAddress()) {
            this.Endpoint.Name = EndpointConfiguration.OServiceAttributeTypesSoap.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public OServiceAttributeTypesSoapClient(EndpointConfiguration endpointConfiguration) : 
                base(OServiceAttributeTypesSoapClient.GetBindingForEndpoint(endpointConfiguration), OServiceAttributeTypesSoapClient.GetEndpointAddress(endpointConfiguration)) {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public OServiceAttributeTypesSoapClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(OServiceAttributeTypesSoapClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress)) {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public OServiceAttributeTypesSoapClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(OServiceAttributeTypesSoapClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress) {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        ...
        public System.Threading.Tasks.Task<Windows8Ont.OServiceAttributeTypes.Config[]> ConfigAsync() {
            return base.Channel.ConfigAsync();
        }
        
        public System.Threading.Tasks.Task<Windows8Ont.OServiceAttributeTypes.clsOntologyItem[]> AttributeTypesAsync() {
            return base.Channel.AttributeTypesAsync();
        }
        
        public System.Threading.Tasks.Task<Windows8Ont.OServiceAttributeTypes.clsOntologyItem[]> AttributeTypesByAttributeTypeGuidAsync(string guidAttributeType) {
            return base.Channel.AttributeTypesByAttributeTypeGuidAsync(guidAttributeType);
        }
        
        public System.Threading.Tasks.Task<Windows8Ont.OServiceAttributeTypes.clsOntologyItem[]> AttributeTypesByAttributeTypeNameAsync(string nameAttributeType, bool strict, bool caseSensitive) {
            return base.Channel.AttributeTypesByAttributeTypeNameAsync(nameAttributeType, strict, caseSensitive);
        }
        
        public System.Threading.Tasks.Task<Windows8Ont.OServiceAttributeTypes.clsOntologyItem[]> AttributeTypesByAttributeTypeIdDataTypeAsync(string idDataType) {
        ...
        private static System.ServiceModel.Channels.Binding GetBindingForEndpoint(EndpointConfiguration endpointConfiguration) {
            if ((endpointConfiguration == EndpointConfiguration.OServiceAttributeTypesSoap)) {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration) {
            if ((endpointConfiguration == EndpointConfiguration.OServiceAttributeTypesSoap)) {
                return new System.ServiceModel.EndpointAddress("http://localhost/OntWeb/OServiceAttributeTypes.asmx");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
        
        private static System.ServiceModel.Channels.Binding GetDefaultBinding() {
            return OServiceAttributeTypesSoapClient.GetBindingForEndpoint(EndpointConfiguration.OServiceAttributeTypesSoap);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress() {
            return OServiceAttributeTypesSoapClient.GetEndpointAddress(EndpointConfiguration.OServiceAttributeTypesSoap);
        }
        
        public enum EndpointConfiguration {
            
            OServiceAttributeTypesSoap,
        }
    }
}
